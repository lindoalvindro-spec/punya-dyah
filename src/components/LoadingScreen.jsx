  ...
  return (
    <div
      ...
      style={{
        ...
        inset: 0,
        zIndex: 9999,
        background: 'radial-gradient(circle at 50% 45%, #2e0821 0%, #1c0515 55%, #0d010a 100%)',
        display: 'flex',
    ...
    >
      ...
      >
        ...
        >
          <svg viewBox="0 0 200 200" width="100%" height="100%">
            ...
            <circle cx="100" cy="100" r="7" fill="#f472b6" />
          </svg>
        </div>
        ...
        <div
          style={{
            ...
            color: '#fff',
            textShadow: '0 0 8px #ff2a8d, 0 0 16px #e0115f',
            pointerEvents: 'none',
          }}
        >
          {progress}%
      ...
      >
        ...
        >
          {isFinished ? 'Pesan Spesial Untuk Dyah' : 'Menyiapkan pesan tulus untukmu...'}
        </h2>
        ...
        >
          {isFinished ? 'Sentuh tombol di bawah untuk membuka 🌸' : 'Ditulis dengan segenap ketulusan hati 💕'}
        </p>
        ...
        >
          <div
            ...
            style={{
              width: '0%',
              height: '100%',
              background: 'linear-gradient(90deg, #ff2a8d, #f472b6, #db2777)',
              borderRadius: '10px',
              boxShadow: '0 0 10px #ff2a8d, 0 0 16px #f472b6',
        ...
        {isFinished && (
          <div className="ready-button-area" style={{ position: 'relative', display: 'inline-block', width: '100%', maxWidth: '240px', opacity: 0 }}>
            ...
            >
              <Sparkles size={20} color="#f472b6" style={{ filter: 'drop-shadow(0 0 8px #f472b6)' }} />
            </div>
            ...
            <button
              ...
              style={{
                position: 'relative',
                background: 'linear-gradient(135deg, #ff2a8d 0%, #f472b6 40%, #db2777 80%, #ff2a8d 100%)',
            ...
            >
              ...
              <Sparkles size={16} color="#f472b6" style={{ filter: 'drop-shadow(0 0 4px #f472b6)' }} />
              <span style={{ textShadow: '0 0 8px rgba(0,0,0,0.5)', letterSpacing: '0.5px' }}>Buka Pesan 🌸</span>
